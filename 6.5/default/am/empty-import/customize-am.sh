...
echo "AM new customization script"
mkdir -p /var/tmp/patch && cp ./patch/idxAuthRequestNode-1.2.2.jar -d /var/tmp/patch
cp -r /var/tmp/patch/idxAuthRequestNode-1.2.2.jar "$CATALINA_HOME"/webapps/openam/WEB-INF/lib
